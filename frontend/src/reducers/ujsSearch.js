...
import {
  SEARCH_UJS_BY_NAME_STATUS,
  SEARCH_UJS_BY_NAME_SUCCESS,
  UPLOAD_UJS_DOCS_PENDING,
  UPLOAD_UJS_DOCS_FINISHED,
      ...
      const newState = Object.assign({}, state, {
        ...
        entities: Object.assign({}, state.entities, {
          [docNum]: Object.assign({}, state.entities[docNum], {
            [keyField]:
              newValue !== null ? newValue : !state.entities[docNum][keyField],
          }),
        }),
      });
      return newState;
...
/**
 * The ujsSearchReducer slice of Redux state.
 * status: explains if the search is currently in progress or not.
 * casesFound: A normalized collection of search results.
 * uploadUJSDocs:
 */
